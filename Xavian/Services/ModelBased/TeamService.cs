using _serviceModel = Xavian.DataContext.Models.Team;
...
namespace Xavian.Services
{
    ...
    public class TeamService : DefaultService<_serviceModel>, ITeamService
    {
        XavianDbContext _context;
        IAuthenticationService _authenticationService;
        IOptions<Configurations> _config;

        public TeamService(XavianDbContext context, IAuthenticationService authenticationService, IOptions<Configurations> config) : base(context, authenticationService, config, IQueryables.IQueryables.Team)
        {
            _context = context;
