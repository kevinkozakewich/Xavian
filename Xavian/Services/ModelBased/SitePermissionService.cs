using _serviceModel = Xavian.DataContext.Models.SitePermission;
...
namespace Xavian.Services
{
    ...
    public class SitePermissionService : DefaultService<_serviceModel>, ISitePermissionService
    {
        XavianDbContext _context;
        IAuthenticationService _authenticationService;
        IOptions<Configurations> _config;

        public SitePermissionService(XavianDbContext context, IAuthenticationService authenticationService, IOptions<Configurations> config) : base(context, authenticationService, config, IQueryables.IQueryables.SitePermission)
        {
            _context = context;
